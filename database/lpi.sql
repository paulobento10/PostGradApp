...
INSERT INTO `evento` VALUES (6,'alteracao do projeto','A definir','2018-04-02','09:00:00','13:00:00',1,'skype','912664700','urgente','','pedro',50,50,9),(7,'alteracao do projeto','A definir','2018-04-05','09:00:00','13:00:00',1,'skype','912664700','urgente','','pedro',50,50,9);
...
CREATE TABLE `projeto` (
  ...
  CONSTRAINT `projeto_ibfk_1` FOREIGN KEY (`utilizador_id`) REFERENCES `utilizador` (`id`)
...
INSERT INTO `projeto` VALUES (9,'teste','Engenharia Informatica','elearning',0,'2018-04-02',50,50,NULL,NULL);
...
INSERT INTO `utilizador` VALUES (53,'009699','Prof New','labproaulas@gmail.com',NULL,1,0,'$2y$11$UXP9yUCLofTX2IzUyn0jhOvqjI/fEHvU1u/twpsMJlt9tTgcbC57O',0,0,'','','123456789','1234','1234',NULL,1),(54,'114584','Paulo Bento','33959@ufp.edu.pt','',1,0,'$2y$11$NXdloIyfV0IFByAyM1tbKeHeFVsnCH5KF8T7YRaLktrc8YTWsXgj.',1,0,'','','987654321','123','123',NULL,1);
...
-- Dump completed on 2018-04-03 13:07:46
